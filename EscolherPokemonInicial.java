...
public class EscolherPokemonInicial extends JPanel{
    ...
    public void editar(Game frame) {
        ...
        JButton bulbasaurOption = new JButton(new ImageIcon("assents/pokemons/bulbassaulto.png"));
        ...
        JButton charmanderOption = new JButton(new ImageIcon("assents/pokemons/chalizarBaby.png"));
        ...
        JButton squirtleOption = new JButton(new ImageIcon("assents/pokemons/squitou.png"));
