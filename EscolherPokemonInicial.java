...
public class EscolherPokemonInicial extends JPanel{
    ...
    private void editar(Game frame) {
        ...
        ActionListener nextPage = e -> {
            ...
            Tutorial tutorial = new Tutorial(frame, new String[]{ "Incrivel,  " + Player.nome + "!", pokemonEscolhido + "Excelente escolha  para  começar.", "Boa  sorte  em  sua  Aventura  Pokemon!" }, new Home(frame));
